...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:rgba(128,128,128,.85);width:240px;height:160px}' +
    '.frame{position:absolute;inset:0;overflow:hidden;background:rgba(128,128,128,.12)}' +
    ...
    '.empty .sub u{text-underline-offset:2px;text-decoration-color:rgba(128,128,128,.4)}' +
    '.empty:hover .sub u{color:rgba(128,128,128,1);text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid #c96442;outline-offset:-2px;' +
    '  background:rgba(201,100,66,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed rgba(128,128,128,.4);' +
